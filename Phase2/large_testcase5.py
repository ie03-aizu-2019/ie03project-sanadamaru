...
for i in range(0,100):
    ...
    if flag == 0:
        print("%d %d 1" %(random.randint(1,200),random.randint(1,200)));
    elif flag == 1:
        print("%d C%d 1" %(random.randint(1,200),random.randint(1,1000)));
    elif flag == 2:
        print("C%d %d 1" %(random.randint(1,1000),random.randint(1,200)));
    elif flag == 3:
